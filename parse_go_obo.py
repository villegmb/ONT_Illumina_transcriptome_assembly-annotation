...
Python script is a helper function that can be called by other scripts to parse and return GO annotation data.

Script requires a _file object_ (not filename).

code from https://github.com/lyijin/annotating_proteomes/tree/master
...
go_term_file = open('/ibex/tmp/c2078/Heat_stress_analysis/scripts/go_analysis/go-basic.obo')
